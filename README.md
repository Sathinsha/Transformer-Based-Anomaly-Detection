Got it! Your README content is already very detailed and well-structured — great job on that.  
I'll now **make it beautiful** by polishing the language a little, improving the formatting, and **add your name ("Sathinsha Semasinghe")** to the appropriate places like the title, footer, and author sections.
...
Would you also like me to create a slightly more "professional" or "corporate" styled version too (depending on your audience)? 🚀  
And if you want, I can create a **clean badge section** at the top (like Python version, License, etc.) too! 🎖️  
Want me to? 🔥